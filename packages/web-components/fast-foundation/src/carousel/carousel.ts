...
export class Carousel extends FASTElement {
    ...
    public connectedCallback(): void {
        ...
        if (!this.slidePicker) {
            ...
            const tabs: any = this.carousel.querySelector("fast-tabs::part(tablist)");
            // TODO: START HERE HOW TO GET THE TAB LIST AND HIDE IT???
            // const tabs: NodeListOf<HTMLDivElement> = this.querySelectorAll('fast-tabs::part(tablist)');
            console.log(tabs);
        }
    }
